...
#define ENGINE_STEP				5 		//Engine step in ms.
...
#define OBJ_FILE_MAX_VERTEX		64000
#define OBJ_FILE_MAX_NORMALS	64000
#define OBJ_FILE_MAX_TEXTCOORDS	64000
#define OBJ_FILE_MAX_TRIANGLES	32000
